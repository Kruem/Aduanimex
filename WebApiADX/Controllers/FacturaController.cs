namespace WebApiADX.Controllers
{
    ...
    public class FacturaController : ApiController
    {
        #region Método
        [HttpGet]
        public List<LiquidacionModel> Fac(string NroDo, string NroPedido, string Tipo, string Nit, bool Cliente)
        {
            if (Cliente == true)
            {
                if (NroDo != null)
                {
                    string cScript = "Exec app_liquidacion '" + NroDo + "','','" + Tipo + "','" + Nit + "',''";
                ...
                {
                    string cScript = "Exec app_liquidacion '','" + NroPedido + "','" + Tipo + "','" + Nit + "',''";
                    DataTable oTabla = new DataTable();
                    SqlConnection oCon = new SqlConnection(ConfigurationManager.ConnectionStrings["Pruebas"].ConnectionString);
                    SqlDataAdapter oAdap = new SqlDataAdapter(cScript, oCon);
                    var lista = new List<LiquidacionModel>();
            ...
            else
            {
                if (NroDo != null)
                {
                    string cScript = "Exec app_liquidacion '" + NroDo + "','','" + Tipo + "','',''";
                    DataTable oTabla = new DataTable();
                    SqlConnection oCon = new SqlConnection(ConfigurationManager.ConnectionStrings["Pruebas"].ConnectionString);
                    SqlDataAdapter oAdap = new SqlDataAdapter(cScript, oCon);
                    var lista = new List<LiquidacionModel>();
                ...
                {
                    string cScript = "Exec app_liquidacion '','" + NroPedido + "','" + Tipo + "', '',''";
                    DataTable oTabla = new DataTable();
                    SqlConnection oCon = new SqlConnection(ConfigurationManager.ConnectionStrings["Pruebas"].ConnectionString);
                    SqlDataAdapter oAdap = new SqlDataAdapter(cScript, oCon);
                    var lista = new List<LiquidacionModel>();
